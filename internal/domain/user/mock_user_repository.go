...
func (m *MockIUserRepository) UpdateUser(ctx context.Context, user *User) (*User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserRepositoryMockRecorder) UpdateUser(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
