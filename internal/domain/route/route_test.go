	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				bbox:               Geometry{orb.Polygon{{{139.6917, 35.6895}, {139.7000, 35.6895}, {139.7000, 35.6900}, {139.6917, 35.6900}, {139.6917, 35.6895}}}},
		...
		},
		{
			...
			wantErr: true,
			errMsg:  "bbox is required",
		},
		{
			name: "異常系: bboxがPolygonではない",
			args: args{
				userID:             string(userID),
				name:               "Test Route",
				description:        "This is a test route",
				...
				elevationLoss:      5.0,
				pathGeom:           Geometry{orb.LineString{{139.6917, 35.6895}, {139.7000, 35.6900}}},
				bbox:               Geometry{orb.Point{139.6917, 35.6895}},
				firstPoint:         Geometry{orb.Point{139.6917, 35.6895}},
				lastPoint:          Geometry{orb.Point{139.7000, 35.6900}},
				visibility:         1,
			},
			wantErr: true,
			errMsg:  "bbox must be a Polygon",
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			testRoute, _ := NewRoute(
				...
				Geometry{orb.Polygon{{{139.6917, 35.6895}, {139.7000, 35.6895}, {139.7000, 35.6900}, {139.6917, 35.6900}, {139.6917, 35.6895}}}},
